...
**Pratham Sharma** (Student)
Guided by **Dr. Manish Kumar** (as per assignment PDF)
...
* Add **screenshots / flowchart image** from your PDF
* Split the Java project into packages and folder structure
